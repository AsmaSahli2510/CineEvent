...
export default function StatisticsPage() {
  return (
    <>
      ...
      <div className="statistics-page bg-background-dark text-white min-h-screen">
        <AdminPageFrame
          title="Platform Global Analytics"
          subtitle="Real-time performance metrics and executive financial oversight">
              ...
              <div className="bg-charcoal border border-white/10 rounded-2xl p-8">
                ...
                <div className="mt-12 p-6 rounded-2xl bg-primary/10 border border-primary/20">
                  ...
                  <p className="text-xs text-white/70 leading-relaxed">
                    ...
                    <span className="text-white font-bold">18.4%</span> since
                    the introduction of premium gala series in metropolitan
                    hubs.
                  </p>
                </div>
              </div>

  ...
  return (
    <>
      ...
      <div className="donations-page bg-background-dark text-white min-h-screen">
        <AdminPageFrame
          title="Donations"
          subtitle="Oversee charitable campaigns and contribution flow">
          <div className="flex">
            <aside className="hidden w-64 min-h-screen bg-charcoal border-r border-white/5 flex-col fixed left-0 top-0 z-50">
              <div className="p-8">

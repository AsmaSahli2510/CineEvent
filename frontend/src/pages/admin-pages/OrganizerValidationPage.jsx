    ...
    <>
      ...
      <div className="organizer-validation-page bg-background-dark text-white min-h-screen">
        <AdminPageFrame
          ...
          <main className="max-w-[1600px] w-full p-4 md:p-6 flex gap-5">
            <div className="w-[34%] flex flex-col gap-4">
              ...
              <div className="space-y-3 overflow-y-auto custom-scrollbar pr-2 max-h-[calc(100vh-220px)]">
                {loading && (
                ...
                {!loading && pendingOrganizers.length === 0 && (
                  <div className="rounded-xl border border-accent/20 bg-gradient-to-b from-accent/10 to-transparent p-5">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs leading-relaxed text-white/60">
                          There are currently no organizer applications waiting
                          for validation.
                        </p>
                      </div>
                    </div>
                    ...
                    <button
                      className="mt-4 inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/5 px-3 py-2 text-xs font-semibold text-white/80 transition-colors hover:bg-white/10"
                      onClick={fetchPending}
                      type="button">
                  ...
                  pendingOrganizers.map((organizer) => {
                    ...
                    return (
                      <button
                        className={
                          isActive
                            ? "w-full text-left p-4 bg-primary/20 border-l-4 border-accent rounded-r-xl border-y border-r border-white/10"
                            : "w-full text-left p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all"
                        }
                        key={organizer._id}
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl flex-1 flex flex-col overflow-hidden">
                {!selectedOrganizer ? (
                  <div className="flex-1 p-8">
                    {!loading && pendingOrganizers.length === 0 ? (
                      <div className="h-full rounded-2xl border border-accent/20 bg-gradient-to-br from-accent/10 via-white/0 to-transparent p-8 flex flex-col items-center justify-center text-center">
                        <div className="mb-4 rounded-full border border-accent/30 bg-accent/15 p-4">
                        ...
                        <button
                          className="mt-6 inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/5 px-4 py-2 text-sm font-semibold text-white/85 transition-colors hover:bg-white/10"
                          onClick={fetchPending}
                          type="button">
                          <span className="material-symbols-outlined text-sm">
                            refresh
                  ...
                  <>
                    <div className="p-4 border-b border-white/10 flex items-center justify-between bg-white/[0.02]">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center text-accent text-xl font-black">
                      ...
                      <div className="flex gap-3">
                        <button
                          className="flex items-center gap-2 px-4 py-2 bg-accent/10 border border-accent/30 text-accent rounded-lg text-sm font-bold hover:bg-accent/20 transition-all"
                          type="button">
                          <span className="material-symbols-outlined text-sm">
                            account_balance
                          </span>
                    ...
                    <div className="flex-1 flex overflow-hidden">
                      <div className="flex-1 p-5 bg-charcoal/50 flex flex-col items-center justify-center border-r border-white/10 overflow-y-auto custom-scrollbar">
                        <div className="w-full max-w-lg">
                          ...
                          <div className="aspect-[1/1.05] bg-white rounded-lg shadow-2xl relative overflow-hidden flex items-start p-4 text-charcoal">
                      ...
                      <div className="w-72 p-4 flex flex-col gap-4 bg-white/[0.01]">
                        <div>
                          ...
                          <div className="space-y-3">
                            {CHECKLIST_ITEMS.map((item) => (
                              <label
                                className="flex items-center gap-2 p-2.5 bg-white/5 rounded-xl border border-white/10 hover:border-accent/30 transition-all cursor-pointer"
                                key={item.key}>
                                <input
                                  checked={
                        ...
                        <div className="flex-1">
                          ...
                          <textarea
                            className="w-full h-28 bg-charcoal/40 border border-white/10 rounded-xl p-3 text-xs focus:ring-accent focus:border-accent resize-none placeholder:text-white/20"
                        ...
                        <div className="flex flex-col gap-3">
                          <button
                            className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-xl shadow-lg shadow-green-600/10 flex items-center justify-center gap-2 transition-all disabled:opacity-60"
                            disabled={approving}
                          ...
                          <button
                            className="w-full bg-primary/10 hover:bg-primary/20 border border-primary/30 text-primary-light text-red-400 font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-60"
                            disabled={rejecting}

    ...
    <>
      ...
      <div className="admin-dashboard-page text-white">
        <AdminPageFrame
          ...
          subtitle="Global analytics and performance monitoring">
          <div className="flex min-h-screen bg-background-dark">
            <aside className="hidden w-72 border-r border-white/5 bg-charcoal flex-col sticky top-0 h-screen">
              <div className="p-8">
                ...
                <nav className="space-y-2">
                  <Link
                    className="flex items-center gap-4 px-4 py-3 rounded-xl bg-primary/20 text-accent border border-primary/30"
                    to="/admin/dashboard">
                  ...
                  <Link
                    ...
                    <span className="font-bold text-sm">Event Validation</span>
                  </Link>
                  <Link
                    className="flex items-center gap-4 px-4 py-3 rounded-xl text-white/60 hover:text-white hover:bg-white/5 transition-all"
                    to="/admin/comments/moderation">
                    <span className="material-symbols-outlined">flag</span>
                    <span className="font-bold text-sm">Moderation</span>
                  </Link>
                  <Link
                    className="flex items-center gap-4 px-4 py-3 rounded-xl text-white/60 hover:text-white hover:bg-white/5 transition-all"
                  ...
                  <Link
                    ...
                    <span className="font-bold text-sm">Organizer Wallet</span>
                  </Link>
                  <Link
                    className="flex items-center gap-4 px-4 py-3 rounded-xl text-white/60 hover:text-white hover:bg-white/5 transition-all"
                    to="/admin/statistics">
                  ...
                  <Link
                    ...
                    <span className="font-bold text-sm">Venue Templates</span>
                  </Link>
                </nav>
              </div>
              ...
              <div className="mt-auto p-8 border-t border-white/5">
                ...
                <div className="space-y-4">
                  <Link
                    className="flex items-center gap-3 p-3 bg-red-500/5 rounded-xl border border-red-500/20 hover:border-red-500/40 transition-colors"
                    to="/admin/comments/moderation">
                  ...
                  <Link
                    className="flex items-center gap-3 p-3 bg-accent/5 rounded-xl border border-accent/20 hover:border-accent/40 transition-colors"
                    to="/admin/organizers/validation">
            ...
            <main className="flex-1 overflow-y-auto px-6 md:px-12 py-10">
              <header className="hidden flex justify-between items-center mb-10">
                <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <span className="material-symbols-outlined text-white/60 hover:text-accent cursor-pointer p-2">
                      notifications
                    </span>
                  ...
                  <div className="flex items-center gap-3 ml-4 border-l border-white/10 pl-6">
                    ...
                    <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center text-charcoal font-black">
                      AD
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-card-dark border border-white/5 p-6 rounded-2xl relative overflow-hidden group">
                  ...
                  <h4 className="text-white/40 font-bold text-sm uppercase tracking-wider">
                    Active Users
                  </h4>
              ...
              <div className="bg-card-dark border border-white/5 rounded-2xl p-8 mb-10 relative chart-grid">
                <div className="flex items-center justify-between mb-10">
                  <div>
                    ...
                    <p className="text-white/40 text-sm">
                      Monthly active participation &amp; revenue velocity
                    </p>
                  </div>
                  <div className="flex gap-2">
                    ...
                    <button className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-xs font-bold text-white/40">
                      2023
                    </button>
                  </div>
                </div>
                ...
                <div className="h-[400px] w-full relative flex items-end justify-between px-4">
                  ...
                  <svg
                    ...
                    <path
                      d="M0,350 L100,320 L200,340 L300,280 L400,300 L500,220 L600,240 L700,180 L800,150 L900,100 L1000,120 L1100,50 L1200,50 V400 H0 Z"
                      fill="url(#chartGradient)"
                    />
                    <path
                      d="M0,350 L100,320 L200,340 L300,280 L400,300 L500,220 L600,240 L700,180 L800,150 L900,100 L1000,120 L1100,50 L1200,50"
                      fill="none"
                      stroke="#F5C065"
                      strokeLinecap="round"
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-white/5">
                      <tr className="hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-8 py-5">
                          <span className="px-3 py-1 bg-accent/10 text-accent text-[10px] font-black rounded-full border border-accent/20">
                            PENDING REVIEW
                          </span>
                        </td>
